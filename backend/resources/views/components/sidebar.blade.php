<div class="flex flex-col h-full bg-white/90 dark:bg-slate-900/95" x-data x-init="$store.sidebar.init()">
    ...
    <div class="flex items-center justify-between p-5 border-b border-gray-200/30 dark:border-slate-700">
        <div class="flex items-center gap-3">
            ...
            <span x-show="$store.sidebar.open" x-transition:enter="transition ease-out duration-300"
    ...
    <nav class="flex-1 p-4">
        <ul class="space-y-2">
            ...
            <li
                x-data="{ open: {{ request()->routeIs('roles.*') || request()->routeIs('permissions.*') || request()->routeIs('users.assign') ? 'true' : 'false' }} }">
            ...
            <li>
                <a href="{{ route('cities.index') }}"
                    class="sidebar-item {{ request()->routeIs('cities.*') ? 'active' : '' }}">
            ...
            <li>
                <a href="{{ route('areas.index') }}"
                    class="sidebar-item {{ request()->routeIs('areas.*') ? 'active' : '' }}">
            ...
            <li>
                <a href="{{ route('universities.index') }}"
                    class="sidebar-item {{ request()->routeIs('universities.*') ? 'active' : '' }}">
