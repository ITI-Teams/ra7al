// src/app/core/services/property/property.service.ts
...
export class PropertyService {
   ...
   */
  getAreas(areaId: number): Observable<Area[]> {
    return this.http
      .get<AreaResponse>(`${environment.apiUrl}/areas/${areaId}`)
      .pipe(
        map((res) => res.data),
        catchError((error) => {
